...
const BASE_CONFIG = {
  ...
  production: {
    protocol: "https",
    wsProtocol: "wss",
    host: process.env.NEXT_PUBLIC_API_URL || "api.myscrollr.com",
    paths: {
      accounts: process.env.NEXT_PUBLIC_ACCOUNTS_PORT || "/api/accounts",
      finance: process.env.NEXT_PUBLIC_FINANCE_PORT || "/api/finance",
      sports: process.env.NEXT_PUBLIC_SPORTS_PORT || "/api/sports",
    },
  },
};
